...
IMAGE_CARDS = [
    ...
    ("f2.jpg", 2, 3,   False),  # ②地上に出たら1週間の命。そう習った人が多いはずです。
    ("f3.jpg", 4, 9,   False),  # ③この数字、実は…結果は、1週間どころでは…
    ("f4.jpg", 10, 14, False),  # ④記録された最長は…誰も数えていなかった数字だったんです。
    ("f5.jpg", 15, 16, False),  # ⑤あなたの周りの常識も、実は間違っているかもしれません。
]
