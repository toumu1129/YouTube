...
s029は動画2本（f1/f5.mp4）＋静止画3枚（f2/f3/f4.jpg）の構成。
- f1.mp4・f5.mp4はPexelsの同一動画（子連れの群れ、Roman Odintsov）の別区間を
  1080x1920に切り出したもの（①冒頭と⑤締めで使用）。
- f2.jpg（顔のアップ）、f4.jpg（親子のゾウ）はPexelsの実写。
- f3.jpg（音声波形とAI解析のオーバーレイ）は①②④⑤の実写トーンに合わせ、
  実写のゾウに図解を重ねる形で生成したAI画像（プロンプトはこのチャットの
  やりとり参照）。1080x1920で生成済み。
"""
...
IMAGE_CARDS = [
    ...
    ("f2.jpg", 3,  4,  "image"),  # ②しかもイルカやオウムと違い…真似てはいません。
    ("f3.jpg", 5,  7,  "image"),  # ③研究チームが469種類の…確認されました。
    ("f4.jpg", 8,  9,  "image"),  # ④名前は、子どもへの呼びかけや…使われます。
    ("f5.mp4", 10, 12, "video"),  # ⑤ゾウは、私たちと同じように…かもしれません。
]
