...
s009は静止画6枚（f1/f2/f3/f3b/f4/f5.jpg）の構成（動画クリップは使わない）。
...
構図の生成画像（f4.jpg）。写真ベースだが記号が描き込まれている
（実験内容を伝えるための演出として許容。詳細は台本の「素材」欄）。

⑤は当初Pexelsの川面動画だったが、生まれた川に帰り着いた2匹のサケの
生成画像（f5.jpg）に差し替えた。
"""
...
IMAGE_CARDS = [
    ...
    ("f5.jpg",       15, 18, "image"),  # ⑤匂いの記憶を手がかりに…生まれ故郷に帰りましたか？
]
